...
const [Bessie,, Dolly, Babe, Little] = farmAnimals.split(' '); //the double comma means 'skip the next element in the collection'
...
const { k_album: {the_muppet_movie: {song_2, song_4}}, k_color, k_job, k_partner } = k_muppet;