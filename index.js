...
// 3. Little the chicken had to go back to the coop, now there are three.
...
// 5. Some people have a really hard time picking out indigo,
//    so let's leave that one out, using the first letter of each color
...
// 7. Use destructuring to assign all appropriate variables
//    using the keys as the variable names
...
// const {k_color} = k_muppet.k_color;
