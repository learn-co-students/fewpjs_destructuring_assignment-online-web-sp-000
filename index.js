...
const splitArray = farmAnimals.split(" ");

const [moo, neigh, baa, oink, cluck] = splitArray;
// 2. Bolt the horse wandered off, so just give us four animals, and let's name them Bessie, Dolly, Babe, and Little.

const [Bessie, , Dolly, Babe, Little] = splitArray;
...
const [black_and_white, , black, pink, , ] = splitArray;
