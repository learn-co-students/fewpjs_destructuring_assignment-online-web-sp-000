...
let animals = ["cow", "sheep", "pig", "chicken"]
...
let[black_and_white, black, pink] = animal;
...
let[name, color, song, job, partner] = [muppet['name'], muppet['color'], muppet['song'], muppet['job'], muppet['partner']]

// 8. Use destructuring to assign songs 2 and 4, and Kermit's job and partner

let[song_2, song_4, k_job, k_partner] = [k_muppet['k_album']['the_muppet_movie']['song_2'], k_muppet['k_album']['the_muppet_movie']['song_4'], k_muppet['k_job'], k_muppet['k_partner']];
